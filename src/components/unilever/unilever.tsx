...
export function CaseStudyPage() {
  ...
  return (
    <main className="bg-white pt-28 lg:pt-32 xl:pt-40 pb-8 md:pb-20">
      ...
      <div className="md:w-[90%] 2xl:max-w-9xl mx-auto">
        <img
          src="/png/blog4.png"
      ...
      <div className=" self-center grid lg:grid-cols-12 w-[90%] 2xl:max-w-9xl mx-auto">
        <div className=" hidden lg:col-span-1 text-[#65A30D] mb-2 md:mb-4 lg:flex  gap-2 text-base xl:text-xl font-semibold"></div>
          ...
          <div className=" space-y-12">
            ...
            <section>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                ...
                Netherlands. Its products include food and beverages, personal
                care products, cleaning agents and personal care products. It is
                the world's largest consumer goods company measured by revenue.
                Unilever is the largest producer of soap in the world and one of
                the oldest multinational companies. Its products are available
            ...
            <section>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                With the diverse number of projects, Unilever was working on, it
                was becoming increasingly difficult to manage them.
                ...
                keep track of their projects. Unilever wanted to have a grasp of
                all any time the second challenge was to coordinate and
                personalize their internal business logic into the application
                so were developing. One of the core requirements was to be able
                to track the progress of their projects in real time and get
                insights about their performance. The application needed to be
                user-friendly and provide comprehensive reports and metrics so
                an intuitive and unique solution to ensure key information was
            ...
            <section>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                ...
                large business data model, we were engaged to develop a content
                project management tool on top of that model. We performed live
                data synchronization with their existing systems and databases
                to ensure that the data was always up to date. The solution
                included a comprehensive dashboard that provided real-time
                insights into project status, timeline, and finished them to
                record time, only a couple of weeks after the kickoff meeting.
              </p>
            </section>
            {/* The Results */}
            <section>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                Even though we delivered the project within the given timeframe,
                the client was very satisfied with the final result. By
                providing various information on one page in a smart manner and
                introducing the use of different forms for data input, we
                minimized the amount of clicking user needs to get to where they
                want to be.
              </p>
            </section>
      ...
      {/* Testimonial Section */}
      <div className="bg-gray-100 py-10 md:py-20 hidden md:block">
        <div className="w-[90%] 2xl:max-w-9xl mx-auto">
          <div className=" self-center grid lg:grid-cols-12">
            ...
            <div className="lg:col-span-11">
              <div className="text-[#003262]  flex items-center gap-2 font-semibold text-xl md:text-2xl mb-10">
                <span className="block lg:hidden">/ 02</span>
