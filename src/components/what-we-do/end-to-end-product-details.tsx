...
export default function EndToEndProductDetails() {
  ...
  return (
    <section className="pb-10 md:pb-20 lg:pb-32 xl:pb-40">
      <div className="w-[90%] 2xl:max-w-9xl mx-auto">
        {/* Header with breadcrumb and icon */}

        <div className=" self-center grid lg:grid-cols-12">
          <div className=" hidden lg:col-span-1 text-[#003262] mb-2 md:mb-4 lg:flex  gap-2 text-base xl:text-xl font-semibold"></div>
        <div className="lg:col-span-11">
          <div className="flex justify-between items-center mb-5 md:mb-16  border-b border-[#84CC16] pb-5">
          ...
          <AnimatePresence mode="wait">
            {tabsData.map((tab, idx) => {
              ...
              return (
                ...
                >
                  {/* Main heading */}
                  <div className="md:text-end mb-5 md:mb-20">
                    <h2
                      className="hidden md:block text-5xl  lg:text-7xl xl:text-8xl font-bold text-[#0060BA] leading-tight 
