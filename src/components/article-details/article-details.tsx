  ...
  return (
    <div className=" bg-white pt-40 pb-20">
      ...
      <main className="w-full px-8">
        <div className="mb-12">
          <div className="text-[#65A30D] max-w-3xl lg:max-w-6xl 2xl:max-w-7xl mx-auto  relative font-semibold text-base md:text-2xl">
        ...
        <div className="">
          ...
          <div className="lg:col-span-3">
            {/* Article Header */}
            <div className="mb-8">
              <h1 className="text-base md:text-2xl lg:text-5xl font-semibold text-[#003262] mb-6 leading-tight max-w-3xl lg:max-w-6xl 2xl:max-w-7xl mx-auto py-6">
                {params.get("title") ||
              ...
              <div className="flex flex-col lg:flex-row gap-10">
                <div className="prose w-full lg:w-[85%] text-sm md:text-xl">
                  <p className="text-[#0060BA] leading-relaxed font-semibold mb-6">
                    If you're wondering what knowledge is used to support
                    millions of concurrent users with multiplayer games, you're
                    in the right place. This session is the first part of a
                    three-part series where we'll explore the technical
                    challenges, architectural patterns, and frameworks, and go
                    different routing models to support such complexity.
                  </p>

                  <p className="text-[#0060BA] font-semibold leading-relaxed mb-6">
                    We want to show you how to deploy to scale thousands and up
                    to millions of players simultaneously. We'll cover the
                    infrastructure, the technology stack, and the primary goal
                    of achieving supporting millions of concurrent users.
                  </p>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    other engineers teach and learn about actor-model
                    programming, and to quickly meet incredible performance
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    this project was different in terms of domain aspects, and
                    it was a difference in comparison that my team and I have
                    been recently working on, like projects where the primary
                    goal was to solve complex business problems in various
                    domains where they are typically labeled as enterprise
                    software. This project was about a simple mobile game called
                    Roshambo, also known as Rock, Paper, Scissors.
                  </p>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    same time. These are the shapes "rock" (closed fist),
                    "paper" (flat hand), and "scissors" (a fist with the index
                    finger and middle finger extended, forming a V). It is a
                    simultaneous, zero-sum game with only two outcomes: a draw
                    or a win for one player and a loss for the other. A player
                    who chooses rock will beat another who chooses scissors but
                    will lose to one who chooses paper; a play of paper will
                    lose to a play of scissors. If both players select the same
                    shape, the game is considered tied and is usually replayed
                    to break the tie
                  </p>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    focusing on specific issues in terms of gameplay very
                    quickly. To respond to questions as soon as possible, such
                    as:
                  </p>
                  ...
                  <p>
                    ...
                    diagrams to demonstrate that we comprehend the entire
