...
export default function CoreValues() {
  ...
  return (
    <div>
      <div className="w-full mx-auto px-8 lg:max-w-6xl 2xl:max-w-9xl relative mt-10">
        <div className="mb-12">
      ...
      <div className="relative mb-20 mt-10 mx-auto w-full 2xl:max-w-9xl group overflow-hidden">
        <img
          src="/png/meeting.png"
          alt=""
